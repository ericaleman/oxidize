"""
Performance regression tests and benchmarks for oxidize.
"""
import pytest
import time
import json
...
class TestPerformanceBenchmarks:
    ...
    def test_small_file_performance(self, benchmark, xml_file):
        ...
        def parse_small_file():
            return oxidize.parse_xml_file_to_json_string(str(xml_file), "record")
    ...
    def test_medium_file_performance(self, benchmark, temp_dir, large_xml_generator):
        ...
        def parse_medium_file():
            return oxidize.parse_xml_file_to_json_string(str(xml_path), "record")
    ...
    def test_large_file_performance(self, benchmark, temp_dir, large_xml_generator):
        ...
        def parse_large_file():
            ...
            return oxidize.parse_xml_file_to_json_file(str(xml_path), "record", str(output_path))
    ...
    def test_string_vs_file_performance_comparison(self, temp_dir, large_xml_generator):
        ...
        start_time = time.time()
        result1 = oxidize.parse_xml_file_to_json_string(str(xml_path), "record")
        file_to_string_time = time.time() - start_time
        
        start_time = time.time()
        result2 = oxidize.parse_xml_string_to_json_string(xml_content, "record")
        ...
        start_time = time.time()
        count1 = oxidize.parse_xml_file_to_json_file(str(xml_path), "record", str(output_path1))
        file_to_file_time = time.time() - start_time
        
        start_time = time.time()
        count2 = oxidize.parse_xml_string_to_json_file(xml_content, "record", str(output_path2))
...
def test_scalability_with_record_count(temp_dir, large_xml_generator):
    ...
    for count in record_counts:
        ...
        start_time = time.time()
        parsed_count = oxidize.parse_xml_file_to_json_file(str(xml_path), "record", str(output_path))
        end_time = time.time()
