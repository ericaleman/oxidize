"""
Integration tests for basic oxidize functionality.
"""
import pytest
import json
import tempfile
...
def test_parse_xml_string_to_json_string(sample_xml):
    ...
    result = oxidize.parse_xml_string_to_json_string(sample_xml, "record")
...
<root>
    ...
    result = oxidize.parse_xml_string_to_json_string(xml_content, "nonexistent")
    assert result.strip() == ""
